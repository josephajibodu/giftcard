        ...
        <div class="py-8 lg:py-16 mx-auto max-w-screen-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-[#F1F4FC] rounded-lg shadow-lg pb-6 transform transition duration-500 overflow-hidden">
                    <div class="h-48 bg-gray-200 rounded-t-lg mb-4">
                        <img src="{{ asset('/images/giftcards/american-express.webp') }}" class="object-cover h-full w-full transition duration-500 hover:scale-105" alt="giftcards" />
                    </div>
                    <div class="px-4">
                        <p class="text-2xl font-bold mb-2">Amazon <span class="text-indigo-600">E-Card</span></p>
                        <div class="flex flex-col justify-between items-center gap-2">
                            <button data-modal-target="purchase" data-modal-toggle="purchase" class="bg-indigo-600 text-white flex justify-center items-center gap-2 px-4 py-2 rounded-lg shadow hover:bg-indigo-700 transition w-full">
                ...
                <!-- Duplicate the above card div for other cards -->
