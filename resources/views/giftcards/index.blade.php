    ...
    <section class="bg-[#F1F4FC] py-24 md:py-32">
        <div class="py-8 lg:py-16 mx-auto max-w-screen-lg animate__animated animate__fadeIn">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
                @php
                    $animations = ['animate__fadeInLeft', 'animate__fadeInUp', 'animate__fadeInRight'];
                @endphp


                @foreach($giftcards as $giftcard)
                    <div class="bg-[#F1F4FC] rounded-lg shadow-lg pb-6 transform transition duration-500 overflow-hidden animate__animated" data-animation="{{ $animations[$loop->index % 3] }}">
                        ...
                        <div class="px-4">
                            <p class="text-lg lg:text-xl font-bold mb-8">{{ $giftcard['name'] }} <span class="text-indigo-600">E-Card</span></p>
                            <div class="flex flex-col justify-between items-center gap-2">
                                <a href="{{ route('giftcards.show', $giftcard['slug']) }}" class="bg-indigo-600 text-white flex justify-center items-center gap-2 px-4 py-2 rounded-lg shadow hover:bg-indigo-700 transition w-full">
