...
@section('content')
    ...
    <section class="bg-[#F1F4FC] pt-24 md:pt-32 md:mb-8">
        <div class="py-8 px-4 mx-auto max-w-screen-md">
            <h2 class="mb-4 text-5xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">About Us</h2>
            <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 text-md sm:text-xl">Your No.1 stop for any gift card purchase and validation - swift response time, top-notch security, and trusted by over 5,000 users daily.</p>
        </div>
    </section>
    ...
    <section class="pt-8 pb-12">
        <div class="px-4 mx-auto max-w-screen-md">
            <p class="mb-8 text-lg text-gray-700 dark:text-gray-300">We offer a platform where users can purchase digital gift cards from all over the world. We are dedicated to making gift-giving easier, more convenient, and more personal.</p>
