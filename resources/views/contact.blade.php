...
@section('content')
    ...
    <section class="bg-[#F1F4FC] py-24 md:py-32">
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 text-md sm:text-xl">
            ...
            <form action="{{ route('contact-us') }}" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
                ...
                <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-indigo-700 sm:w-fit hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300">Send message</button>
            </form>
        </div>
    </section>
