    ...
    <div class="overflow-hidden bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-screen-lg px-6 lg:px-8">
            <div class="mx-auto gap-x-8">
                ...
                <div class="lg:pt-4">
                    <div class="">
                        <h1 class="lg:mt-2 text-center text-3xl font-bold tracking-tight text-gray-900 pt-8 sm:text-4xl" data-aos="zoom-in" data-aos-animation="600" data-aos-mirror="true">Frequently Asked Questions</h1>
                    </div>
                            ...
                            @foreach ($faqs as $faq)
                                <div class="overflow-hidden border-t" data-aos="fade-up" data-aos-animation="600" data-aos-mirror="true" data-aos-delay="{{ ($loop->index + 1) * 200 }}">
                                    <h2 id="accordion-collapse-heading-{{ $loop->index }}">
                                        <button type="button"
                                                class="flex items-center justify-between w-full p-5 bg-transparent font-medium text-start text-xl gap-3 text-gray-900"
                                        ...
                                        <div class="p-5 pt-0 flex flex-col gap-3">
                                            @if(is_array($faq['answer']))
                                                @foreach($faq['answer'] as $answer)
                                                    <p class="mb-2 text-gray-800 text-lg">{!! $answer !!}</p>
                                                @endforeach
                                            @else
